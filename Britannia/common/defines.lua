...
NDiplomacy = {
	...
	ATTACKING_SOMEONE_DEFENDING_AGAINST_OTHER_RELIGIOUS_GROUP_PIETY_COST = 75,		-- Piety hit for attacking someone who is defending against other religious group
	...
	TRIBAL_VASSAL_CALL_DECLINE_COST_FACTOR = 2, -- Prestige cost multiplier for tribal vassals
	...
	SHORT_REIGN_OPINION_MULT = 2.0,				-- Opinion penalty multiplier to short reign years
	...
	GAVELKIND_MAX_SIZE_BONUS = 0.25,			-- Max demesne size bonus from Gavelkind
	...
	VASSAL_LIMIT_DUKE_MULT = 4.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_KING_MULT = 8.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_EMPEROR_MULT = 15.0, 			-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_GREAT_DUKE_BONUS = 6.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy
	VASSAL_LIMIT_DIPLOMACY_MULT = 0.25,			-- Extra Vassal Limit from ruler and spouse diplomacy
	...
	PRESTIGE_OPINION_DIV = 250,									-- Divider for prestige to vassal opinion (5x higher effect for negative prestige)
	...
	MAX_DIPLO_DISTANCE = 100000,								-- Most diplomacy is disallowed if two rulers are too distant
	...
	MAX_DIPLO_DISTANCE_SAME_CULTURE_GROUP = 100, 				-- Bonus to max diplo distance for being of the same culture group				-- Bonus to max diplo distance for being of the same culture group
	...
	MAX_DISTANCE_REL_HEAD_DEFENSE_JOIN = 600,
	...
	RELEASE_FROM_PRISON_INTERACTION_MUST_HAVE_COST = 0,				-- Is having prestige/piety >= cost required for this action?
	...
	RETIRE_TO_MONASTERY_INTERACTION_MUST_HAVE_COST = 0,				-- Is having prestige/piety >= cost required for this action?
	...
	DEMAND_RELIGIOUS_CONVERSION_INTERACTION_THRESHOLD_FOR_YES = 60,
	...
	INVITE_TO_COURT_INTERACTION_MUST_HAVE_COST = 0,				-- Is having prestige/piety >= cost required for this action?
	...
	TRANSFER_VASSAL_INTERACTION_MUST_HAVE_COST = 0,				-- Is having prestige/piety >= cost required for this action?
	...
	CLAIM_TITLE_INTERACTION_MUST_HAVE_COST = 0,				-- Is having prestige/piety >= cost required for this action?
	...
	SEND_GIFT_NOT_LIEGE_BONUS = 5,							-- Not being the liege of the receiver affects the opinon bonus by this much
	...
	OFFER_VASSALIZATION_INTERACTION_THRESHOLD_FOR_NO = 50,
	OFFER_VASSALIZATION_INTERACTION_THRESHOLD_FOR_YES = 75,
	...
	ASK_FOR_CRUSADE_INTERACTION_ENABLED = 1,						-- Should this action be used at all?							-- Should this action be used at all?		
	...
	DEFENSIVE_PACT_THREAT_LIMIT = 999,							-- The amount of provinces in a realm that is needed for being a valid target of a defensive pact
	...
	RELEASE_VASSAL_TRUCE_DAYS = 1825,
...
NCharacter = {
	WRONG_GOV_FORM_TAX_MOD = -0.25,
	WRONG_GOV_FORM_LEVY_MOD = -0.25,
	...
	ASSIGN_ACTION_DAYS = 15,						-- Days before a Councillor can be assigned a new job in a county
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 90,			-- After 120 days of having their troops raised, vassals will get -1 opinion more of you
	...
	PORTRAIT_MID_AGE_THRESHOLD = 34,				-- Middle age switch for character portraits
	...
	NATURAL_DEATH_CHANCE_AGE_0 = 7,					-- Natural deaths per decade out of 10000 people: Age 0-9
	NATURAL_DEATH_CHANCE_AGE_10 = 3,				-- Natural deaths per decade out of 10000 people: Age 10-19
	...
	NATURAL_DEATH_CHANCE_AGE_40 = 50,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 125,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 450,				-- Natural deaths per decade out of 10000 people: Age 60-69
	NATURAL_DEATH_CHANCE_AGE_70 = 900,				-- Natural deaths per decade out of 10000 people: Age 70-79
	...
	NOT_SPOUSE_FERTILITY_MULT = 0.5,				-- Applied to fertility when two lovers are not married
	...
	INHERITED_OPINION_FACTOR = 0.375,				-- This is the factor of the opinion of the previous holder that gets inherited
...
-- Monthly prestige from held titles
	...
	KING_TITLE_PRESTIGE = 0.75,
	EMPEROR_TITLE_PRESTIGE = 1.25,
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	REQ_DUCHIES_FOR_KINGDOM_CREATION = 0, 		-- Number of held duchies required to create a kingdom (for rulers who are not already kings or emperors)
	...
	BECOME_KING_TITLE_GOLD_CREATION_COST_MULT = 1,	-- The de-jure kingdom of your capital is cheaper to create with the become king ambition
	BECOME_KING_TITLE_PIETY_CREATION_COST_MULT = 1,	-- The de-jure kingdom of your capital is cheaper to create with the become king ambition
...
-- Title creation and usurpation requirements	
	DEJURE_COUNTY_LIMIT_TO_CREATE = 0.75,			-- Fraction of de jure counties that you must control to create a non-imperial title
	DEJURE_COUNTY_LIMIT_TO_USURP = 0.75,			-- Fraction of de jure counties that you must control to usurp a non-imperial title
...
NReligion = {
	CREATE_ANTIPOPE_PRESTIGE_COST = 10000,
	EXCOM_MIN_AUTHORITY = 0.5,
	...
	AUTHORITY_FROM_RELHEAD_PIETY = 0.015,			-- Authority from each 100 piety of religious head
	...
	AUTHORITY_FROM_ORG_RELIGION = 0.1,				-- Authority from being an organized religion
...
NEconomy = {
	...
	TRADE_ZONE_BONUS_MULTIPLIER = 0.0075,				-- Trade posts get the trade zone value * 0.1 * this as a bonus
	TRADE_ZONE_BONUS_MULT_CITY = 0.006,				-- Cities gain similar bonus for a tradepost being in the province
	...
	TAX_TO_LOOT_MULTIPLIER = 0.6,					-- Lootable gold per tax 
	...
	FORT_LOOT_DEFENCE_MULTIPLIER = 1.75,			-- Loot protected gold per fortlevel
	...
	TPC_TO_LOOT_MULTIPLIER = 0.075,					-- Max loot in a navy is max troops * this
	LOOTER_SHIP_MAINT_MULT = 0.25,					-- Religions that are Seafarer have lower ship maintenance costs
	LOOTER_ARMY_MAINT_MULT = 0.5,					-- Armies set to 'Looter' have lower maintenance (only applies while the Realm is at peace!)
	LOOT_PRESTIGE_MULT = 1.2,						-- Whenever you gain loot you also get prestige related to the loot
	LOOT_EVERY_X_DAYS = 1,							-- Loot every this many days
	LOOT_IDEAL_MIN_TROOPS = 600,					-- Minimum troops for maximum loot, less than this scales down the amount looted
	BUILDING_COST_MULT = 0.5,						-- Increases build cost of all buildings
	SILK_ROAD_TP_BUILD_COST_MOT = 0.5,			-- Build cost modifier for non-Merchant republic Trade Posts
...
NMilitary = {
	...
	OTHER_TERRITORY_LEVY_RETURN_PERCENT = 0.35,		-- Percent of subunit that returns to levy when unit is disbanded in non-friendly territory
	LEVY_MAINTENANCE_FACTOR = 1.25,					-- General maintenance factor for levy troops
	HOLDING_LEVY_SIZE_OWNER_MARTIAL_BASE = 1.0,	
	HOLDING_LEVY_SIZE_OWNER_MARTIAL_MULT = 0.01,	-- Levy size modifier: Each point of the holding owner's Martial skill is multiplied with this and added to HOLDING_LEVY_SIZE_OWNER_MARTIAL_BASE
	MERCENARY_MAINTENANCE_FACTOR = 5,				-- Maintenance factor for NORMAL mercenary units
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 0.85,		-- Maintenance factor for VASSALIZED mercenary units
	MERCENARY_HIRE_COST_FACTOR = 0.20,				-- Hire cost factor for mercenary units	
	...
	VASSAL_MERC_HIRE_COST_FACTOR = 0.066,			-- Fraction of nominal hire cost when hiring vassal mercenaries or holy orders
	...
	LEVY_PERCENT_BEFORE_CAN_RAISE = 0.25,			-- Needs at least this much % of full levy before we can raise it
	...
	NUM_DAYS_BETWEEN_SIEGE_MORALE_LOSS = 8,			-- Number of days between morale loss for defender in a siege
	...
	DAYS_BEFORE_FIRST_COMBAT_EVENT = 0,				-- First combat event can't fire before this many days
	...
	MAINLEADER_PRESTIGE_PART = 0.5,					-- The % of the total prestige gained in the battle that the center flank leader will get
	FLANKLEADER_PRESTIGE_PART = 0.25,				-- The % of the total prestige gained in the battle that each other flank leader will get
	BATTLE_UNIT_OWNER_PRESTIGE_MULT = 0.75,			-- The % of the total prestige gained in the battle that will be divided among the participating unit owners
	...
	MERC_REINFORCE_RATE_WHEN_IDLE = 0.075,			-- The rate at which mercenaries and holy orders reinforce when not hired
	...
	BATTLE_PIETY_MULTIPLIER = 0.25,					-- Piety gain/loss multiplier. This is based on the prestige value, so a value of 1 gives a leader as much piety as he gains prestige from combat
	...
	DAYS_UNTIL_HOLDER_GETS_WARSCORE = 60,			-- Days until the war score of the title owner starts increasing, if he controls the Holdings
	DAYS_UNTIL_HOLDER_GETS_WARSCORE_INDEP = 30,		-- Days until the war score of the title owner starts increasing in Independence Wars, if he controls the Holdings
	CONTESTED_TITLE_OCCUPIED_DEF_WARSCORE_BONUS = 20,	-- Amount of ticking warscore per year since Defender started getting the bonus
	CONTESTED_TITLE_OCCUPIED_DEF_WARSCORE_BONUS_INDEP = 25,	-- Amount of ticking warscore per year since Defender started getting the bonus, for independence and tyranny wars (can be overridden separately in religion scripts)
	CONTESTED_TITLE_OCCUPIED_ATT_WARSCORE_BONUS = 20,	-- Amount of ticking warscore per year since Attacker started getting the bonus
	CONTESTED_TITLE_OCCUPIED_ATT_WARSCORE_BONUS_INDEP = 25,	-- Amount of ticking warscore per year since Attacker started getting the bonus, for independence and tyranny wars (can be overridden separately in religion scripts)
	...
	NEUTRAL_SETTLEMENT_SUPPLY_BONUS = 0.15,			-- Neutral supply bonus
	...
	MAX_ATTRITION_LEADER_REDUCTION = -0.35,			-- Center leader reduces max attrition(reduction in actual percent)
	...
	NAVAL_ATTRITION = 0.05,							-- Attrition taken monthly by units loaded on ships
	ARMY_MOVEMENT_SPEED = 4.5,						-- Base movement speed of land units
	NAVY_MOVEMENT_SPEED = 25,						-- Base movement speed of naval units
	ARMY_LOAD_MOVE_COST = 9.0,						-- Movement cost for moving armies onto fleets at sea.
	ARMY_UNLOAD_MOVE_COST = 9.0,					-- Movement cost for moving armies off fleets at sea.
	OVERRUN_RATIO = 12,								-- Ratio needed for total extermination of enemy units
	...
	ATTACKER_ASSULT_DAMAGE_FACTOR = 20,				-- Attacker damage scale factor when assaulting
	DEFENDER_ASSULT_DAMAGE_FACTOR = 0.6,			-- Defender damage scale factor when assaulting
	DAYS_PER_FORTLEVEL_BEFORE_ASSAULT = 12,			-- Number of days until attacker can assault
	...
	LOW_DECADENCE_MORALE_MOD = 0.25,					-- Multiply all morale damage by 1 + ( this * how close we are to 0% decadence )
	HIGH_DECADENCE_MORALE_MOD = 2.0,				-- Multiply all morale damage by 1 + ( this * how close we are to 100% decadence )
	...
	OCCUPATION_PENALTY_MONTHS_DIFFERENT_RELIGIONGROUP = 240,
	...
	LOOT_TAX_MULTIPLIER = 0.55,						-- Base gold looted from raided holdings is (tax * LOOT_TAX_MULTIPLIER) + (total building value * LOOT_BUILDING_MULTIPLIER)
	LOOT_BUILDING_MULTIPLIER = 0.008,				-- Extra gold looted from raided holdings, from buildings (LOOT_BUILDING_MULTIPLIER * building built cost)
	...
	PIKEMEN_PHASE_MELEE_DEFENSE = 9,
	PIKEMEN_PHASE_PURSUE_DEFENSE = 4,
	...
	LIGHT_CAVALRY_PHASE_SKIRMISH_DEFENSE = 2,
	...
	ARCHERS_PHASE_SKIRMISH_DEFENSE = 2,
	...
	SPECIAL_TROOPS_PHASE_SKIRMISH_ATTACK = 6,
	...
	COMMAND_MODIFIER_MARTIAL_MULTIPLIER = 0.1,	-- How much positive command modifiers are increased, and negative modifiers decreased (capped to 100% for negative), per point of martial
	...
	CAPITAL_DUCHY_LIEGE_LEVY_MULT = 0.9,
	CAPITAL_KINGDOM_LIEGE_LEVY_MULT = 0.8,
	CAPITAL_EMPIRE_LIEGE_LEVY_MULT = 0.7,
	...
	MAJOR_BATTLE_WARSCORE = 10.0,					-- The minimum warscore gain needed for a battle to be considered major
	...
	SHATTERED_RETREAT_MAX_PROVINCES = 7,					-- Units can not move longer than this many provinces during a shattered retreat
	...
	SHATTERED_RETREAT_ENEMY_UNIT_MULTIPLIER = -0.8,			-- Multiplier of war friend units in province when evaluating retreat provinces
	...
	SHATTERED_RETREAT_OCCUPIED = -50,						-- Added for occupied provinces when evaluating retreat provinces
	...
	MAX_WARSCORE_FROM_BATTLE_ATTACKERS = 85,				-- Max total warscore attackers can get from battles 
	...
	DESIRED_ALLIANCE_MULTIPLIER_STRENGTH_IN_WARS = 2,		-- As long as the AI is not that much stronger than the enemy, they keep calling allies into wars. Set to 0 to always call all allies into war
...
NDisease = {
	SMALL_TOWN_INCOME = 25.0, -- A coastal town with this income has no chance of starting an outbreak
	BIG_TOWN_INCOME = 65.0, -- A coastal town with this income is always a candidate for starting an outbreak
	MIN_OUTBREAK_CHANCE = 0.01, -- Min chance that an outbreak will happen in a particular town
	...
	INFECTION_CHANCE_MODIFIER_TAXES = 0.007,				-- Multiplied by the province total taxes and added to contagiousness to dermine where to spread
	...
	INFECTION_CHANCE_BASE_PROVINCES_NUMBER = 1.2,			-- How many provinces get infected, as a percentage of the outbreak size, multiplied by contagiousness (ie total = current_size * contagiousness * INFECTION_CHANCE_BASE_PROVINCES_NUMBER)
...
NGraphics = {
	...
	CITY_SPRAWL_DRAW_DISTANCE = 300.0, -- Remove at this distance
...
NAI =
{
	...
	INTERACTION_OPINION_CHANGE_TO_DISCARD_REJECTION = 20,	-- AI will re-evalute offers if opinion has changed by at least this amount, regardless of time left
	...
	PEACEAI_STALLED_WAR_WARSCORE_MONTHS = 48,				-- Months until total warscore decrease takes full effect(linear)
	PEACEAI_INITIAL_DEFENDER_WARSCORE_RELUCTANCE = -10,		-- Initial defender (warscore) reluctance for accepting whitepeace
	MIL_AI_COUNTER_INVADE_DISTANCE_THRESHOLD = 70,			-- Defenders in wars will not counter invade past this distance
	...
	BASE_AI_ARMY_SIZE = 7500,								-- Base size that AI will use when forming armies (multiplied by supply tech)
	...
	TRIBAL_REPUBLIC_THRESHOLD = 800,						-- Determines if AI chooses to become republic or not
	...
	TROOP_STRENGTH_PER_TIER_ENFORCE_PEACE = 1500,			-- For AI to consider how powerful a vassal is
...
NFrontend = 
{
	CAMERA_LOOKAT_X = 1400.0, 			-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 2240.0,
	CAMERA_LOOKAT_SETTINGS_X = 1300.0,  -- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,		-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1048.0,
	CAMERA_START_X = 1400.0,			-- Initial position in main menu
	CAMERA_START_Y = 300.0,				-- Y is height
	CAMERA_START_Z = 2200.0,
	CAMERA_END_X = 1580.0,				-- Move to position in main menu
	CAMERA_END_Y = 485.0,
	CAMERA_END_Z = 2200.0,
	TIME_FROZEN = 10.0,  				-- Time before initial animation starts (some delay here so it should NOT be 0, then the animation starts before you can see it)
	GUI_MOVE_SPEED = 660,				-- How fast sliding gui objects move ( pixels/s )
	MAX_ZOOM_LEVEL = 2700,				-- How far out the player can zoom. Warning: At very high zoom levels, the ground will no longer render
	
	FADE_IN_DONE_TIME = 2.0,
	GUI_START_MOVE_TIME = 1,
	CAMERA_START_MOVE_TIME = 3,
	
	CAMERA_SPEED_IN_MENUS = 0.06,
	
	FRONTEND_POS_X = 1760.0,
	FRONTEND_POS_Y = 485.0,
	FRONTEND_POS_Z = 2100.0,
	FRONTEND_LOOK_X = 1760.0,
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 2480.0,
	
	SETTINGS_POS_X = 1450.0,
	SETTINGS_POS_Y = 190.0,
	SETTINGS_POS_Z = 1350.0,
	SETTINGS_LOOK_X = 1200.0,
	SETTINGS_LOOK_Y = -80.0,		
	SETTINGS_LOOK_Z = 1550.0,
	...
	CREDITS_POS_X = 1880.0,
	CREDITS_POS_Y = 350.0,
	CREDITS_POS_Z = 100.0,
	CREDITS_LOOK_X = 1600.0,
	CREDITS_LOOK_Y = 0.0,	
	CREDITS_LOOK_Z = 1200.0,
},
...
NRulerDesigner =
{
	...
	COST_OPPOSITE_TRAIT_OPINION = 0.25,
	COST_SAME_TRAIT_OPINION = 0.25,
	COST_SAME_RELIGION_OPINION = 0.25,
