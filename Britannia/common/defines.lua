...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_KING_MULT = 1.75,			-- Extra Max Demesne Size from the ruler's rank
...
NEconomy = {
	...
	TAX_TO_LOOT_MULTIPLIER = 0.65,					-- Lootable gold per tax 
	...
	LOOTER_ARMY_MAINT_MULT = 0.4,					-- Armies set to 'Looter' have lower maintenance (only applies while the Realm is at peace!)
	LOOT_PRESTIGE_MULT = 1.1,						-- Whenever you gain loot you also get prestige related to the loot
...
NMilitary = {
	...
	SHATTERED_RETREAT_MORALE_MULTIPLIER = 2,	-- Multiplier of morale regain when shattered
