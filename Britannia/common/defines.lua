...
NMilitary = {
	...
	ARMY_MOVEMENT_SPEED = 6,						-- Base movement speed of land units
	NAVY_MOVEMENT_SPEED = 35,						-- Base movement speed of naval units
	ARMY_LOAD_MOVE_COST = 12.0,						-- Movement cost for moving armies onto fleets at sea.
	ARMY_UNLOAD_MOVE_COST = 12.0,					-- Movement cost for moving armies off fleets at sea.
