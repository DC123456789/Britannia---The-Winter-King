...
NEconomy = {
	...
	LOOTER_SHIP_MAINT_MULT = 0.25,					-- Religions that allow Looting/Raiding have lower ship maintenance costs
...
NFrontend = 
{
	...
	FADE_IN_DONE_TIME = 4.0,
	GUI_START_MOVE_TIME = 1.5,
	CAMERA_START_MOVE_TIME = 5,
