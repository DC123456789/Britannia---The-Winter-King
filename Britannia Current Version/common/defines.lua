...
NEconomy = {
	...
	LOOTER_ARMY_MAINT_MULT = 0.25,					-- Armies set to 'Looter' have lower maintenance (only applies while the Realm is at peace!)
...
NMilitary = {
	...
	LEVY_MAINTENANCE_FACTOR = 1.1,					-- General maintenance factor for levy troops
	...
	MERCENARY_MAINTENANCE_FACTOR = 4.0,				-- Maintenance factor for NORMAL mercenary units
	MERCENARY_VASSAL_MAINTENANCE_FACTOR = 0.75,		-- Maintenance factor for VASSALIZED mercenary units
	MERCENARY_HIRE_COST_FACTOR = 0.25,				-- Hire cost factor for mercenary units	
	...
	VASSAL_MERC_HIRE_COST_FACTOR = 0.1,				-- Fraction of nominal hire cost when hiring vassal mercenaries or holy orders
	...
	BATTLE_WARSCORE_DEFENDER_MULTIPLIER = 1.0,		-- Defenders wins are multiplied with this value, which also means they get more prestige for a win
	...
	SIEGE_MORALE_LOSS = 0.8,						-- Base monthly morale loss in a siege
	...
	DAYS_UNTIL_HOLDER_GETS_WARSCORE = 30,			-- Days until the war score of the title owner starts increasing, if he controls the Holdings
	...
	ARMY_MOVEMENT_SPEED = 7,						-- Base movement speed of land units
	...
	LOOT_TAX_MULTIPLIER = 1.2,						-- Base gold looted from raided holdings is (tax * LOOT_TAX_MULTIPLIER) + (total building value * LOOT_BUILDING_MULTIPLIER)
	...
	RETINUE_HIRE_COST_MULTIPLIER = 0.05,			-- Retinues are free to hire atm, but they cost a lot to reinforce
...
NEngine = {
	EVENT_PROCESS_OFFSET = 8,	 -- Events are checked every X day per character or province (1 is ideal, but CPU heavy)
	COURTIER_EVENT_PROCESS_OFFSET = 16, 	 -- Events are checked every X day for courtiers. Max value of 255
